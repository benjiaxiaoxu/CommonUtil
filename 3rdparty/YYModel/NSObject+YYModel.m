...
static force_inline NSNumber *YYNSNumberCreateFromID(__unsafe_unretained id value)
{
    ...
    if ([value isKindOfClass:[NSString class]])
    {
        ...
        if ([(NSString *)value
             rangeOfCharacterFromSet:dot].location != NSNotFound)
        {
        ...
        else
        {
            switch (meta->_nsType)
            {
                ...
                case YYEncodingTypeNSMutableString: {
                    ...
                    {
                        NSMutableString *string = [[NSMutableString alloc] initWithData:value
...
static void ModelSetWithDictionaryFunction(const void *_key, const void *_value, void *_context)
{
    ...
    __unsafe_unretained _YYModelPropertyMeta *propertyMeta = [meta->_mapper
                                                              objectForKey:(__bridge id)(_key)];
...
static id ModelToJSONObjectRecursive(NSObject *model)
{
    ...
    [modelMeta->_mapper
     enumerateKeysAndObjectsUsingBlock:^(NSString *propertyMappedKey, _YYModelPropertyMeta *propertyMeta, BOOL *stop) {
...
+ (NSArray *)yy_modelArrayWithClass:(Class)cls json:(id)json
{
    ...
    return [self yy_modelArrayWithClass:cls
                                  array:arr];
}
...
+ (NSDictionary *)yy_modelDictionaryWithClass:(Class)cls json:(id)json
{
    ...
    return [self yy_modelDictionaryWithClass:cls
                                  dictionary:dic];
}
